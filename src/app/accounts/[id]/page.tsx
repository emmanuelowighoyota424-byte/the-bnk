...
interface Transaction { id: string; description?: string | null; txType: string; amount: number | string; status: string; referenceId?: string | null; createdAt: string; }
interface Account { id: string; accountType: string; accountNumber: string; routingNumber: string; balance: number | string; availableBalance: number | string; currency: string; status: string; interestRate?: number | string | null; openedAt: string; transactions?: Transaction[]; }
