      ...
      <main className="page-container lg:pl-[17rem]">
        ...
        {loading ? (
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {accounts.map(a => (
              <div key={a.id} className="group overflow-hidden rounded-2xl border bg-white shadow-sm transition hover:-translate-y-0.5 hover:border-indigo-200 hover:shadow-md">
                ...
                <div className="p-5">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <Link href={`/accounts/${a.id}`} className="shrink-0 text-sm font-semibold text-indigo-700 hover:text-indigo-800">
                      View →
                    </Link>
                  </div>
