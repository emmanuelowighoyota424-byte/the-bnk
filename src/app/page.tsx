  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-indigo-950 to-gray-900 flex flex-col">
      <nav className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex items-center justify-between">
        <div className="flex items-center gap-2"><div className="w-10 h-10 bg-indigo-600 rounded-xl flex items-center justify-center"><span className="text-white font-bold text-xl">B</span></div><span className="text-white font-bold text-2xl tracking-tight">The Bnk</span></div>
      ...
      <main className="flex-1 flex items-center justify-center px-4">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg sm:text-xl text-gray-400 mb-10 max-w-2xl mx-auto leading-relaxed">The Bnk unifies banking, wealth management, smart cards, and AI-powered analytics into a single, intelligent platform.</p>
      ...
      <footer className="text-center py-8 text-gray-500 text-sm">&copy; {new Date().getFullYear()} The Bnk. All rights reserved.</footer>
    </div>
  );
}