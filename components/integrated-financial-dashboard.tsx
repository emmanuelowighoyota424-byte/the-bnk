...
export function IntegratedFinancialDashboard() {
  ...
  const { accounts, isLoading: accountsLoading, refetch: fetchAccounts } = useAccountManagement(null, '')
  const { transactions, isLoading: transactionsLoading, refetch: fetchTransactions } = useTransactionHistory(null, '')
