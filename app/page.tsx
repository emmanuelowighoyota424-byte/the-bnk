    ...
    <main className="min-h-screen bg-[#f6f8fb] text-[#10233f]">
      ...
      <section className="mx-auto grid max-w-7xl gap-12 px-6 pb-20 pt-14 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:px-10 lg:pb-28 lg:pt-24">
        <div>
          ...
          <p className="mt-7 max-w-xl text-lg leading-8 text-[#52627a]">Crestline Capital brings everyday banking, long-term planning, and intelligent tools together in one composed financial home—so every decision feels considered.</p>
